...
Dentro das páginas de registro Lightning temos os nossos componentes “ Chat Falae e FlInboxUser”, els podem ser usados como componentes padrão do SalesForce ou seja pode customizar o layout com os componentes tanto do SalesForce quanto do produto Falae. Recomendamos o uso do Layout de Página para o uso do **CLASSIC**.
