...
.. figure:: img/classicDesinstalar4.png
    :width: 200px
    :alt: Solidity logo
    :align: center
...
.. figure:: img/classicDesinstalar6.png
    :width: 250px
    :alt: Solidity logo
    :align: center
...
.. figure:: img/classicDesinstalar9.png
    :width: 250px
    :alt: Solidity logo
    :align: center
...
.. figure:: img/classicDesinstalar11.png
    :width: 850px
    :alt: Solidity logo
    :align: center
...
Pode haver Layouts implantados e estes precisam ser removidos, para removê-los é necessário digitar "layouts de página" em "Busca rápida" e clicar em "layout de página" abaixo de "Caso"  
 
.. figure:: img/classicDesinstalar13.png
    :width: 850px
    :alt: Solidity logo
    :align: center
...
.. figure:: img/classicDesinstalar1.png
    :width: 250px
    :alt: Solidity logo
    :align: center
